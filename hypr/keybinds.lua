-- ══════════════════════════════════════════════════════════════════════════════
--                         KEYBINDINGS
--        Compatible with Hyprland 0.55+ Lua API (tested on 0.56.1)
-- ══════════════════════════════════════════════════════════════════════════════
...
hl.bind("ALT + Tab", hl.dsp.exec_cmd("rofi -show window -show-icons -icon-theme Papirus -theme ~/.config/rofi/window.rasi"))
...
-- Cycle workspaces with Ctrl+Alt+Arrow
...
-- ─── Screen Recording ────────────────────────────────────────────────────────
hl.bind(mod .. " + F9", hl.dsp.exec_cmd('killall -q wf-recorder && notify-send "Recording stopped" || (wf-recorder -g "$(slurp)" -f ~/Videos/Screencasts/recording_$(date +%Y%m%d_%H%M%S).mp4 & notify-send "Recording started")'))
hl.bind(mod .. " + F10", hl.dsp.exec_cmd('killall -q wf-recorder && notify-send "Recording stopped" || (wf-recorder -f ~/Videos/Screencasts/recording_$(date +%Y%m%d_%H%M%S).mp4 & notify-send "Recording started")'))
...
-- Global media controls (works across browser, Spotify, any app)
